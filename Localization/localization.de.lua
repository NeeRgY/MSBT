...
-- itself already runs deDE (no SavedVariables dependency), and re-applied
...
L.MSG_MINIMAP_BUTTON_TOOLTIP	= "Linksklick öffnet die Optionen.\nZiehen zum Verschieben."
...
MikSBT.localePacksCore["deDE"] = Apply
