...
L.MSG_EXPORT_PROFILE_TITLE			= "Export Profile"
L.MSG_EXPORT_PROFILE_HINT			= "Copy this string (Ctrl+C) to share the current profile."
L.MSG_IMPORT_PROFILE_TITLE			= "Import Profile"
L.MSG_IMPORT_PROFILE_HINT			= "Paste an exported profile string (Ctrl+V) below."
L.MSG_INVALID_PROFILE_DATA			= "Invalid or corrupted profile data."
L.MSG_SEARCH_TABS					= "Search settings..."
...
obj["settings"]		= { label="Settings", tooltip="Display options window settings."}
...
obj = L.CHECKBOXES
obj["uiAccentColor"]			= { label="Accent Color", tooltip="Sets the options window's accent color."}
obj["showMinimapButton"]		= { label="Show Minimap Button", tooltip="Shows a button next to the minimap to open MSBT's options. Drag it to reposition."}
...
obj["language"]				= { label="Language:", tooltip="The addon's language. Default follows your game client. A change takes effect after a UI reload."}
...
obj["exportProfile"]			= { label="Export Profile", tooltip="Exports the current profile as a string you can share or back up."}
obj["importProfile"]			= { label="Import Profile", tooltip="Imports a profile from a string as a new profile."}
obj["profileExportClose"]		= { label=CLOSE, tooltip="Closes this window."}
obj["profileImportOkay"]		= { label="Import", tooltip="Imports the profile."}
obj["profileImportCancel"]		= { label=CANCEL, tooltip="Cancels the import."}
obj["fontPreview"]				= { label="Preview", tooltip="Shows a live animated sample using the currently selected font settings."}
obj["resetAccentColor"]			= { label="Reset", tooltip="Resets the accent color to the default."}
obj["resetEverything"]			= { label="Reset Everything", tooltip="Resets ALL MSBT settings and profiles back to their defaults. This cannot be undone."}
...
obj["importProfileName"]	= { label="New profile name:", tooltip="Name of the new profile to import the data into."}
...
obj["windowScale"]			= { label="Window Scale", tooltip="Sets the size of the options window itself."}
obj["windowAlpha"]			= { label="Window Transparency", tooltip="Sets the opacity of the options window itself."}
