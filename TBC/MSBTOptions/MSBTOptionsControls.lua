...
local function CreateIconButton(parent, buttonType)
	...
	button:SetWidth(24)
	button:SetHeight(24)
	button:SetNormalTexture("Interface\\Addons\\MikScrollingBattleText\\TBC\\MSBTOptions\\Artwork\\" .. buttonType .. "Icon")
	button:SetDisabledTexture("Interface\\Addons\\MikScrollingBattleText\\TBC\\MSBTOptions\\Artwork\\" .. buttonType .. "IconDisable")
	button:SetHighlightTexture("Interface\\Addons\\MikScrollingBattleText\\TBC\\MSBTOptions\\Artwork\\" .. buttonType .. "IconHighlight")
