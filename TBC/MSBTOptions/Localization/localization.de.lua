...
-- immediately below only if the client itself already runs deDE (no
...
L.MSG_EXPORT_PROFILE_TITLE			= "Profil exportieren"
L.MSG_EXPORT_PROFILE_HINT			= "Diesen Text kopieren (Strg+C), um das aktuelle Profil zu teilen."
L.MSG_IMPORT_PROFILE_TITLE			= "Profil importieren"
L.MSG_IMPORT_PROFILE_HINT			= "Einen exportierten Profil-Text unten einfügen (Strg+V)."
L.MSG_INVALID_PROFILE_DATA			= "Ungültige oder beschädigte Profildaten."
L.MSG_SEARCH_TABS					= "Einstellungen durchsuchen..."
...
obj["settings"]		= { label="Einstellungen", tooltip="Einstellungen des Optionsfensters anzeigen."}
...
obj = L.CHECKBOXES
obj["uiAccentColor"]			= { label="Akzentfarbe", tooltip="Legt die Akzentfarbe des Optionsfensters fest."}
obj["showMinimapButton"]		= { label="Minimap-Button anzeigen", tooltip="Zeigt einen Button neben der Minikarte, um MSBTs Optionen zu öffnen. Kann per Ziehen verschoben werden."}
...
obj["language"]				= { label="Sprache:", tooltip="Die Sprache des Addons. Standard folgt deiner Spielsprache. Eine Änderung wirkt erst nach einem Neuladen der Oberfläche."}
...
obj["exportProfile"]			= { label="Exportieren", tooltip="Exportiert das aktuelle Profil als Text zum Teilen oder Sichern."}
obj["importProfile"]			= { label="Importieren", tooltip="Importiert ein Profil aus einem Text als neues Profil."}
obj["profileExportClose"]		= { label=CLOSE, tooltip="Schließt dieses Fenster."}
obj["profileImportOkay"]		= { label="Importieren", tooltip="Importiert das Profil."}
obj["profileImportCancel"]		= { label=CANCEL, tooltip="Bricht den Import ab."}
obj["fontPreview"]				= { label="Vorschau", tooltip="Zeigt eine animierte Beispielvorschau mit den aktuell gewählten Schrift-Einstellungen."}
obj["resetAccentColor"]			= { label="Zurücksetzen", tooltip="Setzt die Akzentfarbe auf den Standard zurück."}
obj["resetEverything"]			= { label="Alles zurücksetzen", tooltip="Setzt ALLE MSBT-Einstellungen und Profile auf ihre Standardwerte zurück. Dies kann nicht rückgängig gemacht werden."}
...
obj["importProfileName"]	= { label="Neuer Profilname:", tooltip="Der Name des neuen Profils, in das die Daten importiert werden sollen."}
...
obj["windowScale"]			= { label="Fenstergröße", tooltip="Legt die Größe des Optionsfensters selbst fest."}
obj["windowAlpha"]			= { label="Fenstertransparenz", tooltip="Legt die Deckkraft des Optionsfensters selbst fest."}
...
MikSBT.localePacks = MikSBT.localePacks or {}
MikSBT.localePacks["deDE"] = Apply
if (GetLocale() == "deDE") then Apply() end
